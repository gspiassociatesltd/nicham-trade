      ...
      <div className="grid md:grid-cols-3 gap-3 mt-3">
        <div className="md:col-span-2 bg-white border rounded-xl p-3">
          ...
          <div className="grid grid-cols-2 gap-2 mt-2">
            ...
            <select value={form.category} onChange={e=>setForm({...form, category:e.target.value})} className="border rounded px-2 py-1.5 text-sm"><option>Solar Inverter</option><option>Hand Tools</option><option>Solar Panel</option><option>Battery</option><option>Agro Chemicals</option><option>Industrial Chemicals</option></select>
