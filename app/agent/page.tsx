  ...
  return (
    <main className="min-h-screen bg-gray-50 p-4">
      ...
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow p-6 mt-4">
        ...
        <div className="mt-4 bg-gray-50 p-3 rounded-xl text-[11px]">MTN MoMo Disbursement API pays Agent MoMo instantly on AfricanIES stage confirm. Platform 5% → Flutterwave. Sourcing China 3% → Juicyway Naira→CNY Alipay. USA → Grey Naira→USD. Solves forex CBN block.</div>
      </div>
    </main>
  )
}
