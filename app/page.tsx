...
export default function Home() {
  ...
  return (
    <>
      ...
      <footer style={{background:'#0a3d1f',color:'rgba(255,255,255,0.7)',padding:'24px 0'}}><div className="wrap" style={{display:'flex',justifyContent:'space-between',fontSize:12}}><span>© 2025 NiChAm Trade • GSPI Associates Ltd • Enugu</span><span>Trusted Solar & EV Sourcing Platform</span></div></footer>
